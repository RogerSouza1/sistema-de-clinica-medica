window.onload = function () {
    document.getElementById('paciente-form').addEventListener('submit', function (event) {
        ...
        var email = document.getElementById('paciente-email').value;
        var confirmarEmail = document.getElementById('paciente-confirmar-email').value;
        var senha = document.getElementById('paciente-senha').value;
        var confirmarSenha = document.getElementById('paciente-confirmar-senha').value;
        var dataNascimento = document.getElementById('paciente-data-nascimento').value;
    ...
    var cpfField = document.getElementById('paciente-cpf');
